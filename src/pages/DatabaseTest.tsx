...
import { JWTAuthTest } from '@/components/testing/JWTAuthTest';
import { Button } from "@/components/ui/button";

const DatabaseTest = () => {
  const [activeView, setActiveView] = useState<'connectivity' | 'performance' | 'auth'>('connectivity');
    ...
    <div className="min-h-screen bg-gray-50 p-4">
      <div className="max-w-6xl mx-auto space-y-6">
        <div className="text-center">
          ...
          <p className="text-gray-600">Comprehensive testing for your multi-tenant Neon PostgreSQL setup and JWT authentication</p>
        </div>
        ...
        <div className="flex justify-center space-x-4">
          ...
          <Button
            variant={activeView === 'auth' ? 'default' : 'outline'}
