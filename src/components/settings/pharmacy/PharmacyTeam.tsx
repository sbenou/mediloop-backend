...
// Define a TeamMember interface for display purposes with all needed fields
...
const PharmacyTeam: React.FC<PharmacyTeamProps> = ({ pharmacyId }) => {
  ...
  const fetchTeamMembers = async () => {
    try {
      ...
      // Fetch pharmacy team members from the database
      ...
      // Get the list of user IDs to fetch profiles
      const userIds = pharmacyUsers.map(pu => pu.user_id);
      
      // Fetch user profiles for the pharmacy team members
      ...
      if (profiles) {
        // Map database results to our TeamMember interface
